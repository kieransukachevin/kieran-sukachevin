...
export class ProjectsService {
  projectsInfo = [
    ...
    'description': `<p>Built a single-page, responsive, Angular web app that alphabetizes Spotify playlists.
    ...
    'description': `<p>Built a new UI framework for the open-source Alkalinity Titrator project (a device that performs the titration
      process on a sample of water) using a Python class based, state machine approach.
      Created a comprehensive unit and acceptance testing test suite for the UI state machine framework using Pytest.</p>`,
    ...
    'description': `<p>Built a Python theatre seating simulator that sells and refunds seats with a PyQt5 GUI.
    Implemented a MVC design pattern of interaction between Python classes (model, view, controller).</p>`,
    ...
    'description': `<p>This website! Built a single-page, responsive, Angular website featuring my projects and art.
    ...
    Created original artwork using Blender for this game.</p>`,
    'source': 'https://github.com/kieransukachevin/FutureFrog'
    },
    {'title': 'Drawit', 'img': 'assets/projects/drawit.png',
    'description': `<p>Built an Android drawing app in Java using the Android SDK.
    Implemented an Object-Oriented design approach, utilizing the built in Path, Paint, and Canvas classes to enable simulated drawing on the screen.</p>`,
    ...
    Created original artwork as sprites and other assets for this game.</p>`,
